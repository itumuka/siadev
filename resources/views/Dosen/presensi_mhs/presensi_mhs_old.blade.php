        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <h6 class="box-subtitle">Melihat Presensi Dari Mata Kuliah Diampu</h6>
                </div>
                    ...
                    <div class="box">
                        <div class="box-body ribbon-box bg-primary-light">
                            ...
                            <p class="mb-0 text-danger">
                                *Note: 
                                <ul>
    					            <li class="mb-0 text-danger">Aksi "Clock in" presensi dilakukan oleh mahasiswa di menu Presensi pada dashboard Mahasiswa masing-masing</li>
    					            <li class="mb-0 text-danger">Tombol tambah presensi mahasiswa pada halaman ini digunakan pada kebutuhan tertentu: misalnya ketika presensi susulan (dibantu oleh Tendik/langsung Dosen ybs.)</li>    					            
    					        </ul>
                            </p>
                        </div> <!-- end box-body-->
