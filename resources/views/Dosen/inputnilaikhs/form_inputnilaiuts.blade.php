                ...
                columns: [
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<input type="text" class="form-control p-1 nilai_uts" name="nilai_uts[]" id="nilai_uts" value="' +
                                nilai +
                                '" required><input type="hidden" name="tahun_kurikulum[]" value="' +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(data.tanggalmulai) > parseInt(data.tanggalsekarang) || parseInt(
                            ...
                            // document.getElementById("nilai_uts").disabled = true;
                            $(".nilai_uts").prop("disabled", true);
