                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <ul>
                                        ...
                                        <li style="color: maroon;">Nilai berupa <strong>A, A-, B+, B, B-, C+, C,
                                                C-, D+, D, E</strong></li>
                                    </ul>
                                    </p>
                                </div>
                ...
                columns: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            const kodePenilaian = full.kode_penilaian; // kode_penilaian menentukan aturan
                            let options = [];

                            // Tentukan nilai berdasarkan kode_penilaian
                            if (kodePenilaian === '1') {
                                options = [
                                    { value: 'A', label: 'A' },
                                    { value: 'A-', label: 'A-' },
                            ...
                            const selectedValue = full.nilai_akhir_huruf || "";
                            ...
                            return `
                                <input type="hidden" name="tahun_kurikulum[]" value="${full.tahun_kurikulum}">
                                <input type="hidden" name="id_detail_krs[]" value="${full.id_detail_krs}">
                                <input type="hidden" name="id_matakuliah[]" value="${full.id_matakuliah}">
                                <input type="hidden" name="nim[]" value="${full.nim}">
                                <select name="nilai_akhir_huruf[]" class="form-control p-1 tutupinputnilai" style="width:100%" required>
