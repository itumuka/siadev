                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            var nama_mk = row.nama_matakuliah.replace(/\s+/g, '_'); // Ganti spasi dengan underscore
                    
                            return '<button class="waves-effect waves-light btn btn-xs btn-success export-template" ' +
                                   'data-id="' + row.id_kelas + '" ' +
                                   'data-nama="' + nama_mk + '" ' +
                                   'title="Export Template Nilai UAS">' +
