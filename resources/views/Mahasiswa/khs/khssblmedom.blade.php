    ...
    <div class="container-full">
        ...
        <section class="content">
            <div class="cekpembayaran">
                <div class="box default-content" style="display: none;">
                ...
                <div class="warning-content">
                    <div class="box box-solid bg-warning">
                        ...
                        <div class="box-body text-danger">
                            Anda belum mengisi kuesioner di <a href="#" class="btn btn-xs btn-danger" target="_blank">SIEDOM</a>.Sorry, SIEDOM on maintenance.
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function table_khs(id = 0) {
        ...
        //     console.log('Global status after DataTable initialization:', globalStatus);
        // });
        
    //   table.on('draw.dt', function() {
    //         console.log('Global status after DataTable initialization:', globalStatus);
    //         if (globalStatus == 'notCompletedFilled') {
    //             var newHtml = `
    //                 <div class="box box-solid bg-warning">
    //                     <div class="box-header">
    //                         <h4 class="box-title"><i class="fa fa-exclamation-circle"></i> Data Kuesioner Belum Di Isi</h4>
    //                     </div>
    //                     <div class="box-body text-danger">
    //                         Anda belum mengisi kuesioner di <a href="https://siedom.umuka.ac.id" class="btn btn-xs btn-danger" target="_blank">SIEDOM</a>. Silahkan lengkapi kuesioner terlebih dahulu.
    //                     </div>
    //                 </div>`;
    //             $('.checkedom').html(newHtml);
    //         }
    //     });
        ...
        //     } else if (globalStatus == 'completedFilled') {
