        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Jadwal Mata Kuliah Semester {{ $session_nama_tahunakademik }}</h3>
...
@section('script-master')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var ta = "{{ Session::get('session_tahun') }}";
            var smt = "{{ Session::get('session_semester') }}";
            ...
            var table = $("#tbjadwalmakul").DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ config('setting.second_url') }}mahasiswa/tampil-jadwal-makul",
                    headers: {
