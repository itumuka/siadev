                    ...
                    <form id="form_edit_password" method="POST" autocomplete="off">
                        <div class="modal-body">
                            <div class="form-group row col-sm-6">
                                ...
                                <input class="form-control" type="hidden" name="nim" value="{{ $session_nim }}">
                            ...
                            <div class="form-group row col-sm-6">
                                ...
                                <input class="form-control" type="password" name="re_epasswordbaru" id="re_epasswordbaru"
        ...
        $(document).ready(function() {
            ...
            $('#form_edit_password').on('submit', function(event) {
                ...
                if (epassword == epasswordulang) {
                    ...
                    $.ajax({
                        url: "{{ config('setting.second_url') }}mahasiswa/edit-password",
                        method: "POST",
                        data: form_data,
                        dataType: "json",
                        headers: {
