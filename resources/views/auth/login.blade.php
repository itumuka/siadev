                    ...
                    if (result.success == 'Pegawai') {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                kode_program_studi: result.data.active_kode_prodi || result.data.kode_prodi,
                                nama_program_studi: result.data.active_nama_prodi || '',
                                homebase_prodi: result.data.kode_prodi,
                                dosen_wali: result.data.dosen_wali,
                                id_dosen: result.data.id_pegawai,
                                kaprodi: result.data.pimpinan_prodi,
                                is_kaprodi: result.data.is_kaprodi ? 1 : 0,
                                kaprodi_list: JSON.stringify(result.data.kaprodi_list || []),
                                is_dekan: result.data.is_dekan ? 1 : 0,
                                dekan_list: JSON.stringify(result.data.dekan_list || []),
                                semester: result.smtta[0].semester,
                                tahun: result.smtta[0].tahun,
                                tahun_ajaran: result.smtta[0].tahun_ajaran,
                                token: result.token
