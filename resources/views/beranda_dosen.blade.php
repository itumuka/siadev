        ...
        <section class="content">
            <div class="row" id="here">
                <div class="col-12">
                    ...
                    <input class="form-control" type="hidden" value="{{ Session::get('kode_program_studi') }}"
                        name="kode_prodi" id="kode_prodi">
                    <input class="form-control" type="hidden" value="{{ Session::get('tipe') }}" name="tipe" id="tipe">
                    <input class="form-control" type="hidden" value="{{ Session::get('id_dosen') }}" name="kode_dosen"
                        id="kode_dosen">
                    ...
                    <div class="welcome-banner">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-7 col-xl-8">
                                <span
                                    style="color: #2563eb; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Portal
                                    Akademik Dosen</span>
                                ...
                                <div class="mb-5">
                                    @if (Session::get('dosen_wali') == 1)
                                        <span class="role-badge badge-wali"><i class="fa fa-check-circle mr-5"></i> Dosen
                                            Wali</span>
                                    @endif
                                    @if (Session::get('kaprodi') == 1)
                                        <span class="role-badge badge-kaprodi"><i class="fa fa-star mr-5"></i> Ketua Program
                                            Studi</span>
                                    @endif
                                </div>
                                ...
                                <div class="welcome-profile-meta">
                                    ...
                                    <div class="meta-pill" title="Tahun Akademik Aktif">
                                        ...
                                        TA: <strong>{{ $session_nama_tahunakademik }}
                                            ({{ $session_semester == 1 ? 'Ganjil' : 'Genap' }})</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-5 col-xl-4 mt-20 mt-lg-0">
                                <div class="welcome-action-card">
                                    <div class="action-card-header d-flex justify-content-between align-items-center mb-15">
                                        <h5 class="action-card-title mb-0 font-weight-600 font-size-14"
                                            style="color: #0f172a;">
                                    ...
                                    <div class="action-card-body">
                                        ...
                                        <a href="{{ route('berita_acara_dosen') }}" class="action-item-link">
                                            <div class="action-item d-flex align-items-center">
                                                ...
                                                <div class="action-item-content">
                                                    ...
                                                    <small class="action-item-desc" id="action-desc-jadwal">Memuat
                                                        jadwal...</small>
                                                </div>
                                                <div class="ml-auto">
                                                    <span class="action-badge badge badge-primary"
                                                        id="action-val-jadwal">-</span>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <a href="{{ route('dosenacckrs') }}" class="action-item-link">
                                                <div class="action-item d-flex align-items-center">
                                                    ...
                                                    <div class="action-item-content">
                                                        ...
                                                        <small class="action-item-desc" id="action-desc-krs">Memuat
                                                            status...</small>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <span class="action-badge badge badge-warning"
                                                            id="action-val-krs">-</span>
                                                    </div>
                                                </div>
                                            </a>
                                        @endif
                                        ...
                                        <a href="{{ route('dosen.skripsi.index') }}" class="action-item-link">
                                            <div class="action-item d-flex align-items-center">
                                                ...
                                                <div class="action-item-content">
                                                    ...
                                                    <small class="action-item-desc" id="action-desc-skripsi">Memuat
                                                        status...</small>
                                                </div>
                                                <div class="ml-auto">
                                                    <span class="action-badge badge badge-success"
                                                        id="action-val-skripsi">-</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="card-stat">
                                ...
                                <div class="card-stat-info">
                                    <h5>Kelas Diampu</h5>
                                    <h3 id="stat-kelas"><span class="shimmer"
                                            style="display:inline-block; width:60px; height:24px; border-radius:4px;"></span>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="card-stat">
                                ...
                                <div class="card-stat-info">
                                    <h5>Bimbingan PA</h5>
                                    <h3 id="stat-pa"><span class="shimmer"
                                            style="display:inline-block; width:60px; height:24px; border-radius:4px;"></span>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="card-stat">
                                ...
                                <div class="card-stat-info">
                                    ...
                                    <h3 id="stat-skripsi"><span class="shimmer"
                                            style="display:inline-block; width:60px; height:24px; border-radius:4px;"></span>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="card-stat">
                                ...
                                <div class="card-stat-info">
                                    ...
                                    <h3 id="stat-siap-ujian"><span class="shimmer"
                                            style="display:inline-block; width:60px; height:24px; border-radius:4px;"></span>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="card-chart">
                                ...
                                <div id="schedule-container"
                                    style="min-height: 280px; max-height: 280px; overflow-y: auto;">
                    ...
                    <div class="row mt-10">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-body bg-warning-light d-flex flex-column justify-content-between"
                                    style="border-radius: 16px; height: 535px; padding: 20px;">
                                    <div id="tabel_kalenderakademik" style="height: 440px;"></div>
                                    <div id="kalender_pagination"
                                        class="d-flex align-items-center justify-content-between pt-15"
                                        style="border-top: 1px solid rgba(0, 0, 0, 0.05);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modal-detail-event" tabindex="-1" role="dialog"
                        aria-labelledby="modalDetailEventLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content"
                                style="border-radius: 20px; border: none; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
                                <div class="modal-header" style="border-bottom: 1px solid #f1f5f9; padding: 20px;">
                                    <h5 class="modal-title font-weight-600" id="modalDetailEventLabel"
                                        style="color: #1e293b;"><i class="fa fa-info-circle text-primary mr-2"></i> Detail
                                        Kegiatan</h5>
                                ...
                                <div class="modal-body" style="padding: 24px;">
                                    <div class="d-flex align-items-start">
                                        <div id="event-badge-color"
                                            style="width: 16px; height: 16px; border-radius: 50%; margin-right: 15px; margin-top: 5px; flex-shrink: 0; background-color: #0284c7;">
                                        </div>
                                        <div>
                                            <h4 class="font-weight-600 mb-5" id="event-detail-title"
                                                style="color: #1e293b; line-height: 1.4; font-size: 1.15rem;">-</h4>
                                ...
                                <div class="modal-footer" style="border-top: none; padding: 20px;">
                                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"
                                        style="border-radius: 10px; padding: 8px 16px;">Tutup</button>
                                </div>
                            </div>
                        </div>
                    </div>
