        ...
        <div class="multinav">
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <ul class="sidebar-menu" data-widget="tree"><br><br>
                    ...
                    <div class="media-list media-list-hover">
                        <div class="media py-10 px-0 align-items-center">
                            <a class="avatar avatar-lg status-success" href="#">
                                @if (Session::get('gender') == 'L')
                                    <img src="{{ url('images/svg-icon/color-svg/st-4.svg') }}" alt="pp">
                                @else
                                    <img src="{{ url('images/svg-icon/color-svg/st-3.svg') }}" alt="pp">
                                @endif
                            </a>
                            <div class="media-body">
                                <p>
                                    <span class="font-size-12 text-white">{{ Session::get('nama') }}</span><br>
                                    <span class="font-size-10 text-white">({{ Session::get('username') }})</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <li>
                        <a href="javascript:void(0)" id="bantuan_mhs" title="Download Bantuan Modul Mahasiswa">
