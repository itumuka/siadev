...
<body>
    ...
    <input class="form-control" type="text" name="semester" id="semester" value="{{ $semester }}"> --}}
        ...
        <div style='font-family:Courier New;height:648px;line-height:10px;'>
            ...
            <span style='font-size:18px;'>DAFTAR HADIR PESERTA {{ $jenisUjian }} {{ $semester }}<br><br>TAHUN AKADEMIK {{ $tahun }}<br><br>UNIVERSITAS MUHAMMADIYAH
                KARANGANYAR<br></span>
            </div>
            ...
            <div style='margin-top:20px;'>
                <table border='0' rules='all0' width='100%' style='font-size:12px;line-height:10px'>
                    ...
                    <tr>
                        <td>Hari / Tanggal</td>
                        <td>:</td>
                        <td><span class="haritanggal_{{ $row }}"></span></td>
                    </tr>
                    <tr>
                        <td>Ruang</td>
                        <td>:</td>
                        <td><span class="ruang_{{ $row }}"></span></td>
                    </tr>
                </table>
            </div>
                ...
                success: function(data) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            console.log(result);
                            var ujianTanggal = new Date(result[0]
                                .ujian_tanggal
                            ); // Pastikan tanggal dalam format yang dikenali oleh JavaScript
                            ...
                            $('.haritanggal_{{ $row }}').html(result[0]
                                .ujian_hari + " " + formattedTanggal);
                            $('.ruang_{{ $row }}').html(result[0]
                                .ujian_kode_ruang);
