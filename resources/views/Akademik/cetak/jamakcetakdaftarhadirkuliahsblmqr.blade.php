            ...
            <div style='margin-top:5px;'>
                ...
                <div style='margin-top:50px;font-size:12px;'>
                    <table border='0' rules='all0'>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td style='height:120px;'><img id="ttdsaintek" src="{{ url('ttd/ttdsaintek.png') }}"
                                    width="250" height="120"><img id="ttdkombis"
                                    src="{{ url('ttd/ttdkombis.png') }}" width="250" height="120"></td>
                            <td>&nbsp;</td>
