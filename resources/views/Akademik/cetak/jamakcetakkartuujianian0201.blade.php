                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result[0].semester == "1") {
                                ...
                                $('#headersemester{{ $row }}').html(
                                    "KARTU UJIAN SEMESTER GENAP");
                                $('#smstrtahun{{ $row }}').html(
                                    "Ganjil Tahun Akademik " + tahun + "/" + (parseInt(
                                        tahun) + 1));
                            }

                            $('#headertahun{{ $row }}').html(
                            ...
                            $('#nama_fakultaskecil{{ $row }}').html('Fakultas ' +
                                result[0].nama_fakultas);
                            $('#dekane{{ $row }}').html(result[0].dekan);
                            $('#qrdekan{{ $row }}').html(
                                `<img src="{{ url('qrcode/` + result[0].nidn + `.png') }}" alt="Image" width='60' height='60' id="qrImage{{ $row }}"><br> <small><b>valid_id : ` +
                                result[0].valid_id + `</b></small>`
                            );
