                ...
                var table = $("#kgtregistrasi").DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: null,
                            render: function(data, type, full, meta) {
                                if (full.status_keu == "0") {
                                    return '<label style="color:red;"><i class="fa fa-minus-circle"></i> Belum Bayar</label>';
                                } else if (full.status_keu == '1') {
                                    return '<label style="color:blue;"><i class="fa fa-check-circle-o"></i> Sudah Bayar</label>';
                                }
                            }
                        },
                        {
                            data: null,
                            render: function(data, type, full, meta) {
                                if (full.nim == null || full.nim == '') {
                                    return '<label style="color:orange;"><i class="fa fa-minus-circle"></i> Belum Terdaftar</label>';
                                    ...
                                    return '<label style="color:green;"><i class="fa fa-check-circle-o"></i> Sudah Terdaftar</label>';
