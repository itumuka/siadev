...
@section('script-master')
    <script type="text/javascript">
        ...
        function tambah_mhs(nim) {
            ...
            $.ajax({
                url: "{{ config('setting.second_url') }}akademik/add-mhs-dosenwali",
                method: "POST",
                headers: {
        ...
        $(document).ready(function() {
            ...
            var table = $("#kgtdosenwali").DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ config('setting.second_url') }}akademik/setting-dosenwali",
                    headers: {
                        "Authorization": 'Bearer ' + token,
                        "username": userlogin
                    },
            ...
            function ubah_dosenwali(id, prodi) {
                tbchandmhs = $('#tbchandmhs').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ config('setting.second_url') }}akademik/daftar-mahasiswa",
                        headers: {
                            "Authorization": 'Bearer ' + token,
                            "username": userlogin
                        },
                ...
                tdetail = $('#tbalreadymhs').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ config('setting.second_url') }}akademik/list-mhs-already",
                        headers: {
                            "Authorization": 'Bearer ' + token,
                            "username": userlogin
                        },
                ...
                tdetail.on('click', '#delmhs[data-id]', function(e) {
                    ...
                    swal({
                        ...
                        if (isConfirm) {
                            $.ajax({
                                url: "{{ config('setting.second_url') }}akademik/hapus-mhs-dosenwali",
                                type: 'GET',
                                headers: {
                                    "Authorization": 'Bearer ' + token,
                                    "username": userlogin
