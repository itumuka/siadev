            ...
            <div class="box no-shadow mb-0">
                <div class="box-header no-border px-0">
                    <div class="box-controls pull-right d-md-flex d-none">
                        <a href="{{ route('akdaftardosen') }}" type="button" class="btn btn-sm btn-warning"
            ...
            <div class="modal fade" id="modal_list">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!--<input class="form-control" type="text" name="eid" id="m_id_kelas">-->
                            <div class="table-responsive">
                        ...
                        @if (Session::get('kaprodi') != NULL || Session::get('kaprodi') != '' )
                            <button class="btn btn-rounded btn-primary btn-outline" id="btnValidated">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $("#tbmakulpenawaran").DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ config('setting.second_url') }}akademik/makulpenawaran-ba",
                    headers: {
                ...
                columns: [{
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if(row.validated_ba != 0){
                                bt_validate = '<a href="javascript:void(0)" class="waves-effect waves-light btn btn-xs btn-outline btn-success" title="Telah di validasi"><i class="fa fa-check-square-o"></i></a>'
                            }
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let bt_validate='';
                            if(row.validated_ba != 0){
                                bt_validate = '<a href="javascript:void(0)" class="text-success" title="Telah di validasi"><i class="fa fa-check"></i></a>'
                            }else{
                                bt_validate = '<a href="javascript:void(0)" class="text-default" title="Moderasi"><i class="fa fa-minus fa-1"></i></a>'
                            }
                            return bt_validate;
                        }
                    },
            ...
            table.on('click', '#bt_export', function() {
                var id_kelas = $(this).data('id');
                var mk = $(this).data('mk');
                ...
                var url = "{{ config('setting.second_url') }}akademik/export-ba?" + $.param(query)
            ...
            table.on('click', '#bt_modal_list', function() {
                ...
                tabelba(id_kelas);
                // $('#modal_list #btnValidated').attr('data-id', id_kelas);
                $('#modal_list #btnValidated').data('id', id_kelas);

                if (data['validated_ba'] == 1) {
                    $('#modal_list #btnValidated')
                        .text('Telah divalidasi')
                        .prop('disabled', true)
            ...
            console.log("ID Kelas dari button:", id_kelas);
            console.log("ID Kelas dari attr sebelum update:", $('#modal_list #btnValidated').attr('data-id'));
                // $('#modal_list #m_id_kelas').val(id_kelas);
            ...
            function tabelba(id) {
                ...
                $("#btnValidated").click(function(e){
                    e.preventDefault();
                    var id = $(this).data('id');
                    swal({
                        title: "Apa anda yakin?",
                        text: "jika iya, validasi Jurnal tidak bisa di ubah kembali!",
                        type: "warning",
                        ...
                        if (isConfirm) {
                            $.ajax({
                                url: "{{ config('setting.second_url') }}akademik/validated-ba",
                                type: 'GET',
                                headers: {
                                    "Authorization": 'Bearer ' + token,
                                    "username": userlogin
