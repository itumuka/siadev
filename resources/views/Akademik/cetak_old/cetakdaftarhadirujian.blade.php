...
<body>
    ...
    <div style='font-family:Courier New;height:648px;line-height:10px;'>
        <div style='margin-top:10px;text-align:center;'>
            <span class='nama_matkul_' style='font-size:18px;'></span>
        </div>
                ...
                <thead>
                    <tr>
                        <td
                            ...
                            NO</td>
                        <td style='width:130px;padding-left:5px;text-align:center;'>N.I.M</td>
                        <td style='padding-left:5px;text-align:center;'>NAMA MAHASISWA</td>
                        <td style='width:60px;padding-left:5px;text-align:center;'>NILAI</td>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: "{{ config('setting.second_url') }}akademik/cetak-daftarhadirujian1",
            headers: {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('.nama_matkul_').html('** DAFTAR HADIR UJIAN ' + result[0].nama_matakuliah +
                    ' **');
