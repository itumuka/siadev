                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Form Dosen Wali <code id="l_nama_dosen"></code></span></h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<a href="javascript:void(0)" class="btn btn-xs btn-primary" id="bt_edit"  data-id="' +
                                full.id_pegawai + '" data-nama_dosen="' + full.dosen + '" data-prodi="' + full.kode_prodi +
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: (data, type, full, meta) => {
                                ...
                                full.nim.toString() + '`);" data-id="' + full.nim.toString() +
            ...
            table.on('click', '#bt_edit', function() {
                ...
                $('#l_nama_dosen').html($(this).data('nama_dosen'));
            });
