                ...
                <div class="box-body">
                    ...
                    {{-- <div class="text-right">
                        <div class="btn-group mb-5">
                            <button type="button" class="waves-effect waves-light btn btn-sm btn-dark dropdown-toggle" data-toggle="dropdown"><i class="ti-plus"></i> Tambah</button>
                            <div class="dropdown-menu dropdownprodi">
                            </div>
                        </div>
                    </div> --}}
                    <div class="table-responsive">
                        <table id="tbmakulpenawaran" class="table table-hover table-sm table-striped text-nowrap">
                            <thead class="bg-dark">
                                <tr>
                                    <th>No</th>
                                    <th>Matakuliah</th>
        ...
        $(document).ready(function() {
            ...
            var table = $("#tbmakulpenawaran").DataTable({
                ...
                columns: [{
                    ...
                    //             return '<a href="javascript:void(0)" class="text-info mr-10" id="bt_edit" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> | <a href="javascript:void(0)" class="text-danger del" data-id="'+full.id_tawar+'" data-original-title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a>';
                    //     }
                    // },
