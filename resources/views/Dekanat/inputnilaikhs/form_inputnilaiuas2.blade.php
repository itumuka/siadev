                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <ul>
                                        ...
                                        <li style="color: maroon;">Nilai berupa <strong>A, A-, A/B, B+, B, B-, B/C, C+, C,
                                                C-, C/D, D+, D, E</strong></li>
                                    </ul>
                                    </p>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if (full.nilai_akhir_huruf == 'A') {
                                ...
                                selectE = "selected";
                            } else if (full.nilai_akhir_huruf == 'F') {
                                selectF = "selected";
                            } else {
                            ...
                            return '<input type="hidden" name="tahun_kurikulum[]" value="' + full
                                ...
                                full.nim +
                                '"><select name="nilai_akhir_huruf[]" class="form-control p-1" style="width:100%"><option value="" ' +
                                selectDefault + '>Pilih</option><option value="A" ' + selectA +
                                '>A</option><option value="A-" ' + Amin +
            ...
            $('#form_save_nilaikhs').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ config('setting.second_url') }}dekanat/simpan-nilai-uas",
                    method: "POST",
                    data: form_data,
                    dataType: "json",
                    headers: {
