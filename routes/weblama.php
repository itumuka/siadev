...
Route::middleware(['ceklogin'])->group(function () {
    ...
    Route::get("/akademik/cetak/cetakkartuujian/{nim}/{tahun}/{semester}", "Akademik@cetakkartuujian")->name('cetakkartuujian');
    ...
    Route::get("/akademik/cetak/jamakcetakdaftarhadirujian/{id_tawar}", "Akademik@jamakcetakdaftarhadirujian")->name('jamakcetakdaftarhadirujian');
    Route::get("/akademik/cetak/jamakcetakkartuujian/{nim}/{tahun}/{semester}", "Akademik@jamakcetakkartuujian")->name('jamakcetakkartuujian');
