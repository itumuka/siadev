...
Route::middleware(['ceklogin'])->group(function () {
    ...
    Route::get("/kaprodi/transkrip-nilai", "Kaprodi@transkrip_nilai")->name('kptranskrip_nilai');
    Route::get("/kaprodi/kurikulum", "Kaprodi@kurikulum")->name('kpkurikulum');
    ...
    Route::get("/kaprodi/skripsi/aspek", "Kaprodi@skripsi_aspek")->name('kpskripsi_aspek');
    Route::get("/kaprodi/skripsi/rubrik", "Kaprodi@skripsi_rubrik")->name('kpskripsi_rubrik');
    ...
    Route::middleware(['cekmahasiswa'])->group(function () {
        ...
        Route::get("/mahasiswa/skripsi/seminar", "SkripsiMahasiswaController@seminar")->name('skripsi.seminar');
        Route::get("/mahasiswa/skripsi/bimbingan", "SkripsiMahasiswaController@bimbingan")->name('skripsi.bimbingan');
        Route::get("/mahasiswa/skripsi/ujian", "SkripsiMahasiswaController@ujian")->name('skripsi.ujian');
    });
    // Route::get("/dosen/input-nilai-khs", "Dosen@input_nilai_khs")->name('input_nilai_khs_dosen');
    ...
    Route::middleware(['cekpegawai'])->group(function () {
        ...
        Route::get("/dekanat/skripsi/rekap-penilaian", "Dekanat@skripsi_rekap_penilaian")->name('dknrekap_penilaian_skripsi');
